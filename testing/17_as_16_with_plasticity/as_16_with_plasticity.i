...
[Kernels]
  ...
  active = 'PolycrystalKernel TensorMechanics bndsDiff time_c'
  [./PolycrystalKernel]
...
[AuxKernels]
  ...
  [./failed22]
    type = ParsedAux
    variable = failed
    function = if(sigma22_aux>0.5,1,0)
    args = sigma22_aux
  [../]
[]
...
[Materials]
  active = 'stress CuGrGr strain conc_elas diffusionMat'
  [./CuGrGr]
    # Material properties
  ...
  [./stress]
    ...
    yield_stress = '0 200e6 0.4 500e6'
    use_displaced_mesh = true
  [../]
  [./dependence]
