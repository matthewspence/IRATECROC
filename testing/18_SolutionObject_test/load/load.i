...
[AuxVariables]
  # active = ''
  # Dependent variables
  active = 'bnds sigma11_aux sigma22_aux'
  [./bnds]
...
[Kernels]
  ...
  active = 'TensorMechanics time_c bndsDiff'
  [./bndsDiff]
    type = MatDiffusion
    variable = c
    args = bnds
...
[AuxKernels]
  ...
  active = 'matl_sigma11 matl_sigma22 bndsSolnAux'
  [./bnds_aux]
...
[BCs]
  ...
  active = 'fixed_x fixed_y top_disp left'
  [./left]
    type = DirichletBC
    variable = c
    boundary = left
...
[Materials]
  active = 'stress strain conc_elas diffusionMat'
  [./CuGrGr]
    # Material properties
...
[UserObjects]
  [./bnds_soln]
    ...
    system = aux0
    mesh = ../grain/peacock_run_tmp_out.e
    execute_on = initial
  [../]
[]
