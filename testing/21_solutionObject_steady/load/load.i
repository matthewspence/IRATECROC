...
[AuxVariables]
  # active = ''
  # Dependent variables
  active = 'bndsSol failed sigma11_aux sigma22_aux plastic_strain cAux von_mises'
  [./bnds]
...
[Kernels]
  ...
  active = 'TensorMechanics time_x time_y'
  [./bndsDiff]
    type = MatDiffusion
    variable = c
    args = bnds
...
[AuxKernels]
  ...
  active = 'matl_sigma11 eps_kernel failed cSolAux matl_sigma22 von_mises_kernel bndsSolAux'
  [./bnds_aux]
  ...
  [./failed]
    type = ParsedAux
    variable = failed
    function = if(von_mises>8,if(bndsSol<0.8,1,0),0)
    args = 'von_mises  bndsSol'
    execute_on = timestep_end
  [../]
  [./von_mises_kernel]
...
[Materials]
  active = 'conc_elas finiteStrain isotropic_plasticity_recompute radial_return_stress'
  [./CuGrGr]
    # Material properties
